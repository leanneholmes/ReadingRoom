        ...
        var bookClubs = new List < BookClub > {
          new BookClub {
            Name = "Mystery Readers",
              ...
              MeetingLink = "https://www.zoomlink.com/mysteryreaders",
          ...
          new BookClub {
            Name = "Classic Literature Society",
              ...
              MeetingLink = "https://www.zoomlink.com/classicsociety",
          ...
          new BookClub {
            Name = "Sci-Fi Galaxy Explorers",
              ...
              ReadingPace = "Fast",
              NextMeeting = DateTime.UtcNow.AddMonths(1),
              MeetingLink = "https://www.zoomlink.com/scifigalaxy",
              CurrentBook = "Dune",
          ...
          new BookClub {
            Name = "Historical Fiction Voyage",
              ...
              ReadingPace = "Moderate",
              NextMeeting = DateTime.UtcNow.AddMonths(2),
              MeetingLink = "https://www.zoomlink.com/historicalvoyage",
